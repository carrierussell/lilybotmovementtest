...
export function goForward(motorSpeed2: number, motorTime: number) {
...
export function goRight(motorSpeed3: number, motorTime: number) {
    ...
    export function goLeft(motorSpeed3: number, motorTime: number) {
        pins.analogWritePin(AnalogPin.P0, motorSpeed3)
        pins.digitalWritePin(DigitalPin.P8, 1)
        pins.digitalWritePin(DigitalPin.P13, 0)
        pins.analogWritePin(AnalogPin.P1, motorSpeed3)
